...
HANILIES_AI_API_KEY = os.environ.get('HANILIES_AI_API_KEY', '')
HANILIES_AI_API_URL = os.environ.get(
    'HANILIES_AI_API_URL',
    'https://api.openai.com/v1/chat/completions',
)
HANILIES_AI_MODEL = os.environ.get('HANILIES_AI_MODEL', 'gpt-4o-mini')
