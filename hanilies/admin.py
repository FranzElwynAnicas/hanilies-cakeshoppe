...
from .models import HomeHeroImage, HomeStripImage, UserProfile, BookingCalendarBlock, Cake, CakeOrder, CakeCustomization, Package, PackageOrder, Payment
...
@admin.register(BookingCalendarBlock, site=admin_site)
class BookingCalendarBlockAdmin(BaseRoleAdmin):
